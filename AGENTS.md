...
Always treat project text files as UTF-8 by default.

- Prefer UTF-8 when reading files.
- In PowerShell, prefer commands with explicit UTF-8 encoding such as `Get-Content -Encoding UTF8`.
- If file content appears garbled, retry with explicit UTF-8 before making conclusions or edits.

## Language

Always respond in Traditional Chinese unless the user explicitly requests another language.
